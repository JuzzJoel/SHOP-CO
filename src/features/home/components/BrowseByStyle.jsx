...
const categories = [
  {
    label: "Casual",
    image:
      "/images/categories/image 11.png",
  },
  {
    label: "Formal",
    image:
      "/images/categories/image 12.png",
  },
  {
    label: "Party",
    image:
      "/images/categories/image 13.png",
  },
  {
    label: "Gym",
    image:
      "/images/categories/image 14.png",
  },
];
...
export default function BrowseStyle() {
  ...
  {categories.map((cat, index) => (
    <Link to={`/${cat.label.toLowerCase()}`} key={index}>
      <div className="relative overflow-hidden mb-5 bg-white shadow-sm h-[190px] rounded-xl" >
        <img src={cat.image} alt={cat.label} className="object-cover w-full full" />
