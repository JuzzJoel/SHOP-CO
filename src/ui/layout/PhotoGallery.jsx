...
import ProductCard from '/src/ui/cards/ProductCard';
      ...
      <section id={idGallery} className="flex items-center justify-center w-screen h-auto border-b mt-13 lg:mt-18">
        <div className="w-9/10 max-w-[77.5rem] h-full bg-white flex items-center justify-around flex-col">
          ...
          <div className="flex w-full mt-4 mb-4">
            <ProductList data={data} filterProp={filterProp} filterValue={filterValue} sortProp={sortProp} sortOrder={sortOrder} limit={limit} random={random} viewAll={viewAll}/>
          </div>
          {buttonText && (
